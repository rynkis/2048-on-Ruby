=begin
  ...
  #------------------------------#
  #------+------+------+------#
  |____2_|____2_|____2_|____2_|
  ├------+------+------+------┤
  |____2_|____2_|____2_|____2_|
  ├------+------+------+------┤
  |____2_|____2_|____2_|____2_|
  ├------+------+------+------┤
  |_2048_|____2_|____2_|____2_|
  #------+------+------+------#
=end
...
arrange = -> line {
  ...
  when 4
    if line[0] == line[1]
      line[0] += line[1]
      line[1], line[2], line[3] = line[2], line[3], nil
      $score += line[0]
    end
    if line[1] == line[2]
      line[1] += line[2]
      line[2], line[3] = line[3], nil
      $score += line[1]
    end
...
process = -> args {
  ...
  if args[0]
    ...
    4.times do |i|
      rows << [ lines[3][i], lines[2][i], lines[1][i], lines[0][i] ]
    end
  end
  rows.each do |row|
    ...
    row.reverse! if args[1]
    4.times do |i|
      lines[3][i], lines[2][i], lines[1][i], lines[0][i] = rows[i]
    end unless args[0]
  end
}
